...
def display(service_url, port=None, height=None):
  ...
  Args:
    ...
    height: The height of the frame into which to render the TensorBoard
      ...
      (currently 800).
  """
  _display(service_url, port=port, height=height, print_message=True, display_handle=None)


def _display(service_url, port=None, height=None, print_message=False, display_handle=None):
  ...
  return fn(service_url=service_url, port=port, height=height, display_handle=display_handle)
...
def _display_ipython(service_url, port, height, display_handle):
  import IPython.display
  print('starting at', service_url)
